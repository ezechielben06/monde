...
import { Play, Clock, Flame, Dumbbell, Zap, TrendingUp, CheckCircle2, ChevronRight, Activity, Trophy, Timer, Heart } from 'lucide-react';
...
const WORKOUTS = [
  ...
  { 
    ...
    category: "Pilates",
    coach: "Lucie",
    desc: "Renforcez votre sangle abdominale et votre posture."
  },
  { 
    id: 5, 
    ...
    category: "Cardio",
    coach: "Koffi",
    desc: "Défoulez-vous avec des enchaînements de frappes rythmés."
  },
  { 
    id: 6, 
    ...
    category: "Mobilité",
    coach: "Elena",
    desc: "Améliorez votre souplesse et libérez vos articulations."
  },
  { 
    id: 7, 
    title: "Elite Core Strength", 
    level: "Avancé", 
    duration: "20 min", 
    calories: "280 kcal", 
    img: "fitness-session",
    category: "Musculation",
    coach: "Thomas",
    desc: "La force brute commence par un centre solide et stable."
  },
  { 
    id: 8, 
    ...
    category: "Yoga",
    coach: "Mylène",
    desc: "Connectez votre souffle à chaque geste consciemment."
  },
  { 
    id: 9, 
    title: "Bootcamp de l'Aube", 
    level: "Intermédiaire", 
    duration: "60 min", 
    calories: "550 kcal", 
    img: "hiit-workout",
    category: "Cardio",
    coach: "Alexandre",
    desc: "Démarrez la journée avec une énergie inépuisable."
  },
];
      ...
      <main className="max-w-7xl mx-auto px-8 md:px-12 py-16 space-y-32">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-12 soft-reveal">
          <div className="space-y-8">
            <Badge className="bg-primary/10 text-primary border-primary/30 font-bold px-8 py-2 rounded-full uppercase text-[10px] tracking-[0.4em]">Performance Athlétique</Badge>
            <h1 className="text-7xl md:text-9xl font-headline font-bold text-white tracking-tighter leading-[0.85]">Domptez <br/><span className="luxury-gold-gradient">votre Corps</span>.</h1>
          ...
          <div className="flex gap-8">
            ...
            <div className="text-center p-10 bg-zinc-900/40 rounded-3xl border border-white/5 min-w-[180px] shadow-2xl group hover:border-primary/20 transition-all">
              <p className="text-5xl font-bold luxury-gold-gradient group-hover:scale-110 transition-transform">4.2k</p>
              <p className="text-[10px] text-zinc-600 uppercase font-bold tracking-[0.3em] mt-3">Calories</p>
            </div>
          </div>
        </header>
        ...
        <section className="space-y-16 soft-reveal">
          <div className="flex items-center justify-between border-b border-white/5 pb-8">
            <h2 className="text-5xl font-headline font-bold tracking-tight">Programmes <span className="luxury-gold-gradient">Signatures</span></h2>
        ...
        <section className="bg-zinc-900/40 rounded-[3rem] p-16 md:p-24 relative overflow-hidden border border-white/10 group soft-reveal shadow-2xl">
          <div className="relative z-10 max-w-4xl space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-6xl md:text-8xl font-headline font-bold tracking-tighter leading-[0.85]">La Conquête du <br/><span className="luxury-gold-gradient">Sommet Émeraude</span></h2>
            ...
            <div className="flex flex-wrap gap-8">
              ...
              <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/10 rounded-full px-16 font-bold uppercase tracking-widest transition-all backdrop-blur-xl">Voir les récompenses</Button>
            </div>
          </div>
